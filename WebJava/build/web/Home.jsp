...
<html lang="en">
    <style>
        .card-hover:hover {
            ...
            box-shadow: 0 0.5rem 0.75rem rgb(238, 79, 39) !important;
        }
        .card-title{
            line-height: 1rem;
            width:200px;
    ...
    <jsp:include page="Header.jsp"></jsp:include>
        ...
        <div class="container">
            <div style="margin: 4rem 0;" id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active" data-bs-interval="10000">
                        <img src="content/images/backgroud1.png" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                        </div>
                    </div>
                    <div class="carousel-item" data-bs-interval="2000">
                        <img src="content/images/backgroud2.png" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="content/images/backgroud3.png" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                        </div>
                    </div>
                </div>
            ...
            <h5 style="font-weight:700; margin-top:2rem">SẢN PHẨM NỔI BẬT</h5>
