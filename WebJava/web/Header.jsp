            ...
            <nav class="navbar navbar-expand-lg bg-light shadow-sm" style="position: fixed; z-index: 10; top:0; width:100%;">
                <div class="container-fluid">
                    ...
                    <a class="navbar-brand" href="home">
                        <img  class="logo" src="content/img/logo.jpg" style="height:60px; width:180px" alt="Logo" />
                    </a>
                    <a href="WEB-INF/content/img/logo.jpg"></a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <form action="search" class="d-flex" enctype="multipart/form-data" >
                            <input name="keyword" style="width:300px" class="form-control me-2" type="search" placeholder="Nhập món muốn tìm..." aria-label="Search">
