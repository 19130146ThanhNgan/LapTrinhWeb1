                            ...
                            <div class="modal-body">
                                ...
                                <form action="addsanpham" method="post" enctype="multipart/form-data">
                                    ...
                                    <select name="hang" class="form-select mb-3" aria-label="Default select example">
                                        ...
                                        <option value="Oppo">Cơm</option>
                                        <option value="Iphone">Món Kho</option>
                                        <option value="Samsung">Món Xào</option>
                                        <option value="Samsung">Món Nước</option>
                                        <option value="Xiaomi">Ăn Vặt</option>
                                        <option value="Realme">Trà Sữa</option>
                                        <option value="Vivo">Trà Trái Cây</option>
                                    </select>
